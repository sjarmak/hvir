...
`attention-away-throttling`, `companion`, `companion-mirror-away`, and `companion-prompt-away` groups in separate Electron processes with fresh project and user-data roots, then
...
`harness-profiles`, `attention-away-throttling`, `companion`, `companion-mirror-away`, `companion-prompt-away`, and `capacity`. The
