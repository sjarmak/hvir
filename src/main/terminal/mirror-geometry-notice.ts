...
/**
 * Tells the owning renderer that a Companion mirror holds its PTY's size, or
 * that the desktop reclaimed it (ADR-052): the id and the held grid, to the
 * exact current owner and generation, so the pane can present a size it did
 * not choose and refit once it is its own again.
 */
