  ...
  return (
    <div className="modal-backdrop nested">
      ...
      >
        ...
        <p>
          To keep this behavior consistent, hvir needs to update the Enter, Ctrl+Enter,
          and Shift+Enter Chat bindings in Claude&apos;s <code>keybindings.json</code> on
          every machine you connect to hvir, now and later while this setting is enabled.
        </p>
        <p>
        ...
        <p>
          ...
          terminals outside hvir. Open Codex sessions keep their launch-time behavior
